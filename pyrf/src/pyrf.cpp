...
PYTHON_RANDOM_FOREST CRForest *forest(CRForestDetectorClass *detector, char **tree_path_array,
                                      int _tree_path_num, bool verbose)
{
    ...
    return detector->forest(tree_path_vector, verbose);
}
...
PYTHON_RANDOM_FOREST void train(CRForestDetectorClass *detector, char *train_pos_chip_path,
                                ...
                                int _train_neg_chip_num, char *trees_path, int patch_width,
                                int patch_height, float patch_density, int trees_num,
                                int trees_offset, int trees_max_depth, int trees_max_patches,
                                ...
                                float trees_prob_optimize_mode, bool verbose)
{
    ...
    detector->train(train_pos_chip_path_string, train_pos_chip_filename_vector,
                    ...
                    trees_path_string, patch_width, patch_height, patch_density,
                    trees_num, trees_offset, trees_max_depth, trees_max_patches,
...
PYTHON_RANDOM_FOREST void detect(CRForestDetectorClass *detector, CRForest *forest,
                                 ...
                                 int RESULT_LENGTH, bool verbose)
{
